<template>
  <div>
    <h2 class="flex items-center justify-center gap-3 font-bold text-xl mb-3">
      <img src="https://i.psray.net/i/2024/08/21/66c53be4a4dad.png" class="w-8 h-8" />
      {{ $t('trophies.ranking.first_achievers') }}
    </h2>
...
async function fetchData() {
  const res = await api.get(`/trophies/ranking/pioneers`, {
    params: {
