<template>
  <div class="w-full mx-auto flex flex-col justify-center border rounded-md shadow-lg p-8">
    <div class="mb-5">{{ $t('dashboard.profile_card.text') }}</div>
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
      ...
      >
        ...
        <div class="relative">
          ...
          <div class="mt-6 pb-6 rounded-b-[--card-border-radius]">
            <h2 class="text-lg font-bold text-gray-900 dark:text-gray-300">白金奖杯墙</h2>
            <p class="text-gray-700 dark:text-gray-300">可以生成已获得的白金奖杯纪念图</p>
          </div>
      ...
      >
        ...
        <div class="relative">
          ...
          <div class="mt-6 pb-6 rounded-b-[--card-border-radius]">
            <h2 class="text-lg font-bold text-gray-900 dark:text-gray-300">个人资料卡片</h2>
            <p class="text-gray-700 dark:text-gray-300">可以生成PSN个人资料卡片</p>
          </div>
      ...
      >
        ...
        <div class="relative">
          ...
          <div class="mt-6 pb-6 rounded-b-[--card-border-radius]">
            <h2 class="text-lg font-bold text-gray-900 dark:text-gray-300">里程碑</h2>
            <p class="text-gray-700 dark:text-gray-300">可以生成已获得的里程碑纪念图</p>
          </div>
          <div class="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">
            <a
              href="#"
      ...
      <div
        class="hidden relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900"
      >
        <div
          aria-hidden="true"
